...
const (
	Hello_Say_FullMethodName = "/templateGRPC.v1.Hello/Say"
)
...
func (c *helloClient) Say(ctx context.Context, in *SayReq, opts ...grpc.CallOption) (*SayRes, error) {
...
func (UnimplementedHelloServer) Say(context.Context, *SayReq) (*SayRes, error) {
...
var Hello_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "templateGRPC.v1.Hello",
	...
	Metadata: "grpc/templateGRPC/v1/hello.proto",
}
