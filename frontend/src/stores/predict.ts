...
export const usePredictStore = defineStore('predict', () => {
  ...
  async function predict(params: { data: Record<string, any>; model_name?: string }) {
    loading.value = true
    error.value = null
  ...
  async function batchPredict(data: Record<string, any>[], modelName?: string) {
    ...
    try {
      ...
      const response = (await predictApi.batchPredict(
        data,
        modelName,
        modelData || undefined,
  ...
  async function exportPredictions(
    ...
    try {
      ...
      const response = (await predictApi.exportPredictions(
        data,
        format,
        modelName,
        modelData || undefined,
