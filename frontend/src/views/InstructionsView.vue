              ...
              <ElCard class="section-card" shadow="never">
                ...
                <ElTimeline>
                  <ElTimelineItem :type="'primary'" :icon="Upload">
                    ...
                    <p>
                      在主页面选择Step1
                      数据标签页，上传CSV格式的数据文件。系统会自动分析数据结构，显示数据预览和基本信息。您可以选择目标列和缺失值处理方式，然后点击处理数据按钮。完成数据处理后，系统将自动允许您进入下一步。
                    </p>
                  </ElTimelineItem>
                  ...
                  <ElTimelineItem :type="'success'" :icon="Setting">
                    ...
                    <p>
                      切换到Step2
                      模型标签页，选择合适的模型类型（如线性回归、随机森林等），设置目标列、测试集比例和是否开启超参数调优，然后点击开始训练模型按钮。系统会显示训练进度和评估指标。
                    </p>
                  </ElTimelineItem>
                  ...
                  <ElTimelineItem :type="'info'" :icon="TrendCharts">
                    ...
                    <p>
                      模型训练完成后，系统会显示详细的评估指标，包括训练集和测试集的性能指标。您可以查看模型准确率、特征重要性等信息，确认模型是否满足需求。
                    </p>
                  </ElTimelineItem>
                  ...
                  <ElTimelineItem :type="'warning'" :icon="Download">
                    ...
                    <p>
                      在Step3
                      预测标签页中，系统将自动使用您在Step2中训练的模型。您可以进行单条预测或批量预测。输入特征值，点击开始预测按钮。预测完成后，可以导出结果为CSV、Excel或JSON格式。
                    </p>
                  </ElTimelineItem>
                </ElTimeline>
              </ElCard>
                ...
                <ElRow :gutter="20">
                  <ElCol :span="12">
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>缺失值处理：</strong>系统提供多种缺失值处理方式，可根据需求选择
                      </li>
                    </ul>
                  </ElCol>
                  <ElCol :span="12">
                    ...
                    <ul>
                      <li>
                        <strong>目标列选择：</strong
                        >目标列必须是数值型数据，且需要在数据处理步骤中指定
                      </li>
                      <li>
                        <strong>训练时间过长：</strong>大数据集训练可能需要较长时间，请耐心等待
                      </li>
                      <li><strong>模型准确率低：</strong>尝试调整测试集比例或开启超参数调优</li>
                      <li><strong>内存不足：</strong>大数据集可能导致内存不足，可考虑减少数据量</li>
                      <li>
                        <strong>无法进入模型训练页面：</strong
                        >确保已完成数据处理步骤，系统会自动允许进入下一步
                      </li>
                    </ul>
                  </ElCol>
                </ElRow>
                ...
                <ElRow :gutter="20" style="margin-top: 20px">
                  ...
                  <ElCol :span="12">
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>数据丢失：</strong>长时间未操作可能导致会话超时，需要重新上传数据
                      </li>
